package com.example.agus.mybiodata;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void openmaps(View v){
        ...
        Uri uri = Uri.parse("https://www.google.com/maps/search/semarang/@-7.074262, 110.409463");
    ...
    public void openemail(View v){
        ...
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"agus.prasetyo47@gmail.com"});
        try {
